                            ...
                            <div class="container">
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <p class="text-sm text-muted">{{ session('nama_mhs') }}</p><hr>
                                        <a href="/mahasiswa/katasandi" class="text-sm btn btn-sm btn-outline-secondary">Ubah Kata Sandi</a><br><br>
                                    </div>
                                </div>
                            </div>
                            <!-- Message End -->
        ...
        <div class="container">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <center><h1 style="font-weight: 700; color: #413A3A">Hasil Pencarian</h1></center><br><hr><br>
                            @foreach($dosen as $dosen)
                                <p style="text-align:justify;"><a href="/mahasiswa/link/{{ $dosen-> id_dosen }}">{{ $dosen-> nama_dosen }}</a></p>
                                <p><a class="text-muted" href="{{ $dosen-> link_dosen }}" style="text-decoration: none;" target="_blank">Kunjungi Google Scholar</a></p> <hr>
                            @endforeach
                            
                            @foreach($bacaan as $data)
                                <p style="text-align:justify;"><a href="/mahasiswa/detail/{{ $data-> id_bacaan }}">{{ $data-> judul }}</a></p>
                                <p style="text-align:justify; font-size:14px">Penulis : {{ $data-> penulis }}</p>
