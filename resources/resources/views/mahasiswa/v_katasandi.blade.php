...
<html lang="en">
    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="#" style="font-weight: 700; font-size:16px;">Profil</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container-fluid d" style="height: 600px">
            <div class="row justify-content-evenly">
                <div class="col-4">
                    <div class="container">
                        <br><br>
                        <h1 style="font-weight: 1000;">{{ session('nama_mhs') }}</h1>
                        <h4 style="font-weight: 1000;color:darkgrey;">{{ session('angkatan') }}</h4>
                    </div>
                    <br><br>
                ...
                <div class="col-4">
                    <div class="container">
                        ...
                        <form method="post" action="/mahasiswa/ubahkatasandi/{{ session('id_mhs')}}" >
                            @csrf
                            <label for="username">Username</label>
                            <input type="text" class="form-control" name="username" id="username" placeholder="{{ session('username_mhs') }}" readonly>
        ...
        <div class="container-fluid d bg-secondary" id="info" style="height: 300px">
            <div class="container">
                <div class="row justify-content-evenly">
                    <div class="col-4">
                        <center>
