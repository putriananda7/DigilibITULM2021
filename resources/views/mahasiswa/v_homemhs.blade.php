            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a href="#" class="nav-link"  style="font-weight: 700; font-size:16px;">Beranda</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="card" style=" background-color: brokenwhite">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <a href="/mahasiswa/daftarbacaan/topik/{{ $data -> id_topik }}" type="button"class="btn btn-md btn-outline-secondary">Lihat Selengkapnya</a>
                                </li>
                            </ul>
                        </div>
                    </div>
