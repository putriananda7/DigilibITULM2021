        ...
        <div class="container">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <center><h1 style="font-weight: 700; color: #413A3A">Daftar Bacaan</h1></center>
                        <center><h3 class="text-muted" style="font-weight: 700;">({{ $detail -> nama_kategori }})</h3></center><br><hr><br>
                        @foreach($bacaan as $data)
                            @if($data-> judul <> "")
                            <p style="text-align:justify;"><a href="/dosen/detail/{{ $data-> id_bacaan }}">{{ $data-> judul }}</a></p>
