        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="#daftar" class="nav-link" style="font-weight: 700; font-size:16px;">Daftar Bacaan</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="row justify-content-evenly">
                    ...
                    <div class="col-4">
                        ...
                        @foreach($id_bacaan as $bacaan)
                            <p style="text-align:justify;"><a href="/dosen/detail/{{ $bacaan }}">{{ trim($judul[$m++], '":judul{}[]') }}</a></p>
            ...
            <div class="container">
                ...
                <div class="row justify-content-evenly">
                    <div class="col-4">
                        ...
                        <form class="form-floating" action="/dosen/masukan" method="post"> 
                            @csrf
